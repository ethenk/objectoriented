...
public class View extends JFrame implements ActionListener {
    ...
    private void clear() {
    	...
    	clearNumbers();
    	Student.setCurrentStudent(null);
    }
